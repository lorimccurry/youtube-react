...
function App() {
    ...
    return (<>
      <Navbar_1.default toggleSidebarOpen={toggleSidebarOpen}/>
      <Sidebar_1.default isSidebarOpen={isSidebarOpen}/>
      <MobileNavbar_1.default />
      <Container_1.default>
        <react_router_dom_1.Switch>
          <react_router_dom_1.Route exact path="/" component={Home_1.default}/>
          <react_router_dom_1.Route path="/watch/:videoId" component={WatchVideo_1.default}/>
          <react_router_dom_1.Route path="/channel/:channelId" component={Channel_1.default}/>
          <react_router_dom_1.Route path="/results/:searchQuery" component={SearchResults_1.default}/>
          <react_router_dom_1.Route path="/feed/trending" component={Trending_1.default}/>
          <react_router_dom_1.Route path="/feed/subscriptions" component={Subscriptions_1.default}/>
          <react_router_dom_1.Route path="/feed/library" component={Library_1.default}/>
          <react_router_dom_1.Route path="/feed/history" component={History_1.default}/>
          <react_router_dom_1.Route path="/feed/my_videos" component={YourVideos_1.default}/>
          <react_router_dom_1.Route path="/feed/liked_videos" component={LikedVideos_1.default}/>
