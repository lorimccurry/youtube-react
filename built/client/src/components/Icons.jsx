...
var LogoIcon = function (props) { return (<svg viewBox="0 0 200 60" style={{
    width: "100%",
    height: "100%",
...
var SubIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA" {...props}>
    <g>
...
var LibIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA" {...props}>
    <g>
...
var HistoryIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA" {...props}>
    <g>
...
var VidIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA" {...props}>
    <g>
...
var WatchIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA" {...props}>
    <g>
...
var MoreIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#AAAAAA" {...props}>
    <g>
      <path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"></path>
    </g>
  </svg>); };
exports.MoreIcon = MoreIcon;
var HamburgerIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="22" width="22" fill="#FFF" {...props}>
    <g>
      <path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path>
    </g>
  </svg>); };
exports.HamburgerIcon = HamburgerIcon;
var UploadIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" height="27" width="27" fill="#FFF" focusable="false" style={{
    top: "5px",
}} {...props}>
    <g>
...
var NotificationIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="27" fill="#FFF" width="27" {...props}>
    <g>
...
var AppsIcon = function (props) { return (<svg viewBox="0 0 24 24" style={{
    width: "27px",
    height: "27px",
...
var CloseIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" {...props}>
    <g>
      <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>
    </g>
  </svg>); };
exports.CloseIcon = CloseIcon;
var SignoutIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" fill="#fff" opacity="0.6" {...props}>
...
var LikeIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" fill="#AAAAAA" width="22" height="22" {...props}>
    <g>
      <path d="M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-1.91l-.01-.01L23 10z"></path>
    </g>
  </svg>); };
exports.LikeIcon = LikeIcon;
var DislikeIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" width="22" height="22" {...props}>
    <g>
      <path d="M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v1.91l.01.01L1 14c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z"></path>
    </g>
  </svg>); };
exports.DislikeIcon = DislikeIcon;
var SubscriptionIcon = function (props) { return (<svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style={{
    pointerEvents: "none",
    display: "block",
    width: "100%",
    height: "100%",
...
var SearchIcon = function (props) { return (<svg viewBox="0 0 24 24" {...props}>
    <path fill="#fff" opacity={0.6} d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
  </svg>); };
exports.SearchIcon = SearchIcon;
var ChannelIcon = function (props) { return (<svg viewBox="0 0 24 24" pointerEvents="none" display="block" fill="#fff" opacity="0.6" {...props}>
    <g>
...
var SignInIcon = function (props) { return (<svg focusable="false" viewBox="0 0 24 24" aria-hidden="true" style={{
