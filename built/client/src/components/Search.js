...
function Search() {
    ...
    return (react_1.default.createElement(Search_1.default, null,
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            react_1.default.createElement("input", { id: "search", type: "text", placeholder: "Search" }),
            react_1.default.createElement("button", { "aria-label": "Search videos and channels", type: "submit" },
