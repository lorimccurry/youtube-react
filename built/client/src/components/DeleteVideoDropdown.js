...
function DeleteVideoDropdown(_a) {
    var video = _a.video;
    var user = auth_context_1.useAuth();
    var history = react_router_1.useHistory();
    var isVideoAuthor = video.userId === (user === null || user === void 0 ? void 0 : user.id);
    function handleDeleteVideo() {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_client_1.deleteVideo(video.id)];
                    case 1:
                        _a.sent();
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(menu_button_1.Menu, null,
                ...
                react_1.default.createElement(menu_button_1.MenuList, null,
                    react_1.default.createElement(menu_button_1.MenuItem, { onSelect: handleDeleteVideo },
                        react_1.default.createElement(Icons_1.DeleteIcon, null),
                        react_1.default.createElement("span", null, "Delete Video"))))));
    }
    return null;
}
exports.default = DeleteVideoDropdown;
