...
function SearchResults() {
    ...
    if (isSuccess && !((_a = data.videos) === null || _a === void 0 ? void 0 : _a.length) && !data.users.length) {
        return (react_1.default.createElement(NoResults_1.default, { title: "No results found", text: "Try different keywords or remove search filters" }));
    }
    return (react_1.default.createElement(Trending_1.default, null,
        react_1.default.createElement("h2", null, "Search Results"),
        react_1.default.createElement(StyledChannels, null, isSuccess
            ? data.users.map(function (channel) { return (react_1.default.createElement(ChannelInfo_1.default, { key: channel.id, channel: channel })); })
            : null),
        isSuccess
            ? data.videos.map(function (video) { return (react_1.default.createElement(TrendingCard_1.default, { key: video.id, video: video })); })
            : null));
}
